...
HD_PWD='C:/Users/Administrator/Desktop/RISCV_FPGA/openc906_FPGA/openc906_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log openc906_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source openc906_top.tcl -notrace
