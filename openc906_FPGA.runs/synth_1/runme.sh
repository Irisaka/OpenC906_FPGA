...
HD_PWD='C:/Users/Administrator/Desktop/RISCV_FPGA/openc906_FPGA/openc906_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log openc906_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source openc906_top.tcl
